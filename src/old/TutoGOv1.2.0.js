...
var alwaysOn, startPage, game, moveScene, moon, fish, logo, lastJump, lastStand, edge, left, right, 
    block, invisBlock, switchBlock, bgm, t, retryPage;
...
var gameState   =   setup;
var gravity     =   0.3, initVx = 4, initVy = -Math.sqrt(2*gravity*270),  xAbs = 0, respawnX = 180, respawnY = 540 ,respawnXAbs =0, died = 0;
