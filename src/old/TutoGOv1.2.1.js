...
var gameState   =   setup;
var gravity     =   0.3, initVx = 3.5, initVy = -Math.sqrt(2*gravity*270),  xAbs = 0, respawnX = 180, respawnY = 540 ,respawnXAbs =0, died = 0;
var maxStageLength = 1800, flagX = maxStageLength - 180, flagY = 120;
